  ...
  getActivePanel: function() {
    ...
    if (this.state.activeTab === this.tabs.SHARE) {
      ...
      socialContent.forEach(function(shareButton) {
        switch (shareButton) {
          case "twitter":
            shareButtons.push(<a key={shareButton} className="oo-twitter" onClick={this.handleTwitterClick}></a>);
            break;
          case "facebook":
            shareButtons.push(<a key={shareButton} className="oo-facebook" onClick={this.handleFacebookClick}></a>);
            break;
          case "google+":
            shareButtons.push(<a key={shareButton} className="oo-google-plus" onClick={this.handleGPlusClick}></a>);
            break;
          case "linkedin":
            shareButtons.push(<a key={shareButton} className="oo-linkedin" onClick={this.handleLinkedInClick}></a>);
            break;
          case "email":
            shareButtons.push(<a key={shareButton} className="oo-email-share" onClick={this.handleEmailClick}></a>);
            break;
        }
      }, this);
